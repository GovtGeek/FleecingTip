...
FT = {
	...
	SHORT = "Short",
	LONG = "Long",
	OPTION_DISPLAY_FLEECING_DESC_SHORT = "Enabled",
	OPTION_DISPLAY_FLEECING_DESC = "Display FleecingTip on items tooltip",
	OPTION_SOUND_FLEECING_DESC_SHORT = "Sound On",
	OPTION_SOUND_FLEECING_DESC = "Give Fleecing Tip some sound",
	OPTION_MONEY_FORMAT_FLEECING_DESC_SHORT = "Money Format",
	OPTION_MONEY_FORMAT_FLEECING_DESC = "Money Format",
};
